...
ACLOCAL = ${SHELL} /root/source_code/SAPP-master/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /root/source_code/SAPP-master/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/source_code/SAPP-master/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/source_code/SAPP-master/build-aux/missing automake-1.15
...
MAINT = 
MAKEINFO = ${SHELL} /root/source_code/SAPP-master/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = sap
PACKAGE_BUGREPORT = www.sappcoin.com
PACKAGE_NAME = Sapphire Core
PACKAGE_STRING = Sapphire Core 1.2.0
PACKAGE_TARNAME = sap
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/source_code/SAPP-master
abs_srcdir = /root/source_code/SAPP-master
abs_top_builddir = /root/source_code/SAPP-master
abs_top_srcdir = /root/source_code/SAPP-master
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/source_code/SAPP-master/build-aux/install-sh
...
DIST_CONTRIB = $(top_srcdir)/contrib/sap-cli.bash-completion \
	       $(top_srcdir)/contrib/sap-tx.bash-completion \
	       $(top_srcdir)/contrib/sapd.bash-completion \
...
COVERAGE_INFO = baseline.info \
  test_sap_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_sap_coverage.info test_sap.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Sapphire-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Sapphire-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Sapphire-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Sapphire-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_sap.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_sap -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_sap_filtered.info: test_sap.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_sap_filtered.info
...
#test_sap_coverage.info: baseline_filtered.info test_sap_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_sap_filtered.info -o $@

#total_coverage.info: test_sap_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_sap_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_sap.coverage/.dirstamp:  test_sap_coverage.info
...
#cov: test_sap.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_sap.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
